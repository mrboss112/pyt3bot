...
#line = LINE()
#line = LINE("เมล","พาส")
line = LINE('Eu7Z1Gsgi0qtXlKKah33.FXP8F/ZJ0UQHfIxYmKf0iW.NSYsbvlRr/nhmGm9/oS3UjRtKLnLRWfN4Aysd7rL+74=')
...
#==============FINNISHING PROTECT========================#
                        ...
                        if settings["Nk"] == False:
                            ...
                            settings["Nk"] = False
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"ปิดข้อความแจ้งเตือนเมื่อมีคนลบสมาชิกในกลุ่มอยู่แล้ว..")
                        ...
                        if settings["Lv"] == True:
                            ...
                            settings["Lv"] = True
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดข้อความอำลาเมื่อมีสมาชิกออกอยู่แล้ว   ")
                        ...
                        if settings["Lv"] == False:
                            ...
                            settings["Lv"] = False
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"ปิดข้อความอำลาเมื่อมีสมาชิกออกอยู่แล้ว  ")
...
#==============================================================================#
            ...
            if msg.toType == 0:
                ...
                if settings["autoJoinTicket"] == True:
                    ...
                    for ticket_id in n_links:
                        ...
                        line.sendMessage(to, "มุดลิ้งเข้าไปในกลุ่มเรียบร้อยแล้ว↖(^ω^)↗ %s" % str(group.name))
        ...
        if op.type == 17:
           ...
           if settings["Wc"] == True:
             ...
             path = line.getProfileCoverURL(dan)
             line.sendImageWithURL(msg.to, str(path))
