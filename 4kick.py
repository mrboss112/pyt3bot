...
ki = LINE('Et9CkaJ8Ht91bFza757c.ovqvmfGzvKpMHoOPQ4Gpta.lEMc1i0nl2tMv2hfSy59gcwscyAM3ecASzeugMC6Pi8=')
ki.log("Auth Token : " + str(ki.authToken))
ki.log("Timeline Token : " + str(ki.tl.channelAccessToken))

kk = LINE('Eti1d8wwbkDudyKJLMke.suxc3CYHYuNtF8LZD0ehhG.+2yOBtWqeB14ebgDU/clFl0ZP1i0Qe6jnTQ2k7GTES8=')
kk.log("Auth Token : " + str(kk.authToken))
kk.log("Timeline Token : " + str(kk.tl.channelAccessToken))

kc = LINE('EtYDNfenMG9GCuqh0WM3.FXP8F/ZJ0UQHfIxYmKf0iW.+ycHgPogFntnvZd48EWaqBBqsm/Y4ok0z059pUPNmYc=')
kc.log("Auth Token : " + str(kc.authToken))
kc.log("Timeline Token : " + str(kc.tl.channelAccessToken))

ke = LINE('Et4m5azq8zDjncgm5VFd.MJjB5RM02td4rFyvdkvFtq.uYOnOjfpsboXpgjN/LwkGW+FCT1DRu0fStTVd35oII4=')
